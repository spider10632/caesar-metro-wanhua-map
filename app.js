...
const TEXT = {
  zh: {
    ...
    jumpFavorites: "蒐藏清單",
    jumpHotel: "飯店資訊",
    note: "使用方式：1. 在「行程條件」選分類或輸入關鍵字。2. 按「搜尋」後會自動跳到「搜尋結果」。3. 點任一地點卡可切換地圖，並可直接開啟 Google Maps 或從飯店出發導航。",
  ...
  en: {
    ...
    note: "How to use: 1) Choose filters or enter keywords in Trip Filters. 2) Tap Search to jump to Search Results. 3) Tap any place card to switch the map, then open Google Maps or start from the hotel.",
  ...
  ja: {
    ...
    jumpFavorites: "保存リスト",
    jumpHotel: "ホテル情報",
    note: "使い方：1. 「条件設定」でカテゴリやキーワードを選択。2. 「検索」を押すと「検索結果」へ移動。3. 地点カードを押すと地図が切り替わり、Googleマップまたはホテル出発ナビを開けます。",
